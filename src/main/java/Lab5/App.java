...
public class App {
    ...
    void run() {
        ...
        try {
            ...
            Book bookexample=new Book("Rudy", 20, 12, "testing");
            
            
            BookJpaController bc=new BookJpaController(emf);
            
            bc.create(bookexample);
            
            List<Book> allBooks= bc.findBookEntities();
