...
import Lab5.entitiesOLD.Ticket;
import Lab5.entitiesOLD.Magazine;
import Lab5.entitiesOLD.Publication;
import Lab5.entitiesOLD.Book;
import Lab5.entitiesOLD.DiscMag;
...
public class App {
    ...
    public void addBook() {
            ...
            book.setCopies(Integer.parseInt(input.nextLine()));
    ...
    public void listBook() {
        ...
        List<Publication> ListOfBooks = em.createQuery("SELECT c FROM book c").getResultList();
            
            for (Publication pub : ListOfBooks) {
